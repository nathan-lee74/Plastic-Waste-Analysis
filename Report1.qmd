...
## Context of the Data
This data comes from Break Free from Plastic, a global organization that runs yearly brand audits where volunteers around the world collect and sort plastic waste by company and plastic type. The dataset contains 2019 and 2020 data, with the following variables: country, year, parent_company, empty, hdpe, idpe, o, pet, pp, ps, pvc, grand_total, num_events, and volunteers.
